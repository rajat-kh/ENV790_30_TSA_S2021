...
nobs <- 444
#ma = 12
rep_trend <- array(NA, dim = c(nobs-12,1))
for (i in 6:nobs-6){
  rep_trend[i] = (clean_wind_data[i+5:i+7] + clean_wind_data[i:i+5])/12
}
#Ex6: Try to reproduce the sesaonal component from decompose().
=======
