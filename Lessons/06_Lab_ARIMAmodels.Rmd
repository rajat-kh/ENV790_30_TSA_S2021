...
setwd('~/Documents/GitHub/ENV790_30_TSA_S2021/Data')
...
ts_inflow_data_decomp <- decompose(ts_inflow_data[,15], "additive")
...
ts_inflow_data_deseasoned <- seasadj(ts_inflow_data_decomp)


#Exercise 3: Compare ACFs for full series and deseason series
par(mfrow=c(1,2))
acf(ts_inflow_data[,15], lag.max = 40, main = "Original")
acf(ts_inflow_data_deseasoned, lag.max = 40, main = "Deseasoned")


#Exercise 4: Compare PACFs for full series and deseason series
par(mfrow=c(1,2))
pacf(ts_inflow_data[,15], lag.max = 40, main = "Original")
pacf(ts_inflow_data_deseasoned, lag.max  = 40, main = "Deseasoned")
...
```{r}
adf.test(ts_inflow_data_deseasoned)
auto.arima(ts_inflow_data_deseasoned)
